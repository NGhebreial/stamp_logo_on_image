...
class WidgetUtils {
  ...
  Positioned createButton(
      Function onPressed, tooltip, Widget icon, EdgeInsets padding,
      {double radius: 26.0}) {
  ...
  Positioned createDragTarget(double width, double height, Offset position,
      String positionLogo, Function toExecute, Widget containerDecoration) {
            ...
            return new InkWell(
              ...
              child: new Container(
                ...
                decoration: new BoxDecoration(
                    color: accepted.isEmpty ? bColorG : bColorB,
